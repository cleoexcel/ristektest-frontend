...
const Login = () => {
    ...
    return (
        <div className="bg-white shadow-lg place-self-center w-11/12 max-w-md flex flex-col p-8 min-h-[500px] border rounded-2xl">
            {/* ------ title --------- */}
            ...
            <div className="mt-6 flex flex-col items-center gap-4">
                <button
                className="bg-[#17726d] hover:bg-[#0d5350] transition-all w-36 h-12 text-white text-lg font-semibold border rounded-full"
                onClick={handleLogin}
                >
                Login
                </button>
